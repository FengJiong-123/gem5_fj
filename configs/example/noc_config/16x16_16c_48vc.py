...
class CHI_RNF(CHI_config.CHI_RNF):
    class NoC_Params(CHI_config.CHI_RNF.NoC_Params):
        ...
        router_list = [  1,  3,  5,  7, 16, 18, 20, 22, 33, 35, 37, 39, 48, 50, 52, 54]
...
class CHI_RNV(CHI_config.CHI_RNV):
    class NoC_Params(CHI_config.CHI_RNV.NoC_Params):
        router_list = [  8,  9, 10, 11, 12, 13, 14, 15, 24, 25, 26, 27, 28, 29, 30, 31, #40, 41, 42, 43, 44, 45, 46, 47, 56, 57, 58, 59, 60, 61, 62, 63,
                       ...
                       192,193,194,195,196,197,198,199,208,209,210,211,212,213,214,215,#224,225,226,227,228,229,230,231,240,241,242,243,244,245,246,247,
                       ...
                       200,201,202,203,204,205,206,207,216,217,218,219,220,221,222,223]#232,233,234,235,236,237,238,239,248,249,250,251,252,253,254,255]
