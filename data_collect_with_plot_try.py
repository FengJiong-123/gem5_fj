...
for i in range(len(OrderSnoopType)):
    if i > 2:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType) *width, Contiguous_snoop[i], width = len(SnoopType) * width, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Contiguous_snoop[i], width = len(SnoopType) *width, bottom=Contiguous_snoop[i-1], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Contiguous_snoop[i-1], Contiguous_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Contiguous_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])

    else:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Contiguous_snoop[i], width = len(SnoopType) *width, label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Contiguous_snoop[i], width = len(SnoopType) *width, bottom=Contiguous_snoop[i-1], label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Contiguous_snoop[i-1], Contiguous_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Contiguous_snoop[i], width = len(SnoopType) *width, bottom=Bottom,label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
...
for i in range(len(job_list)):
    plt.text(x[0] + 0.4 + i, -1, job_list[i], fontsize=14, color='black')
#my_xAxis = np.arange(0- (total_width - width) / 2,len(job_list)- (total_width - width) / 2, (1 / len(Contiguous_order)))
#print(my_xlabel)
#print(my_xAxis)
plt.xticks(my_xAxis, my_xlabel,rotation=20, ha='right', fontsize=8) 
plt.legend(ncol = 5)
...
for i in range(len(OrderSnoopType)):
    if i > 4:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType) *width, Random_snoop[i], width = len(SnoopType) * width, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Random_snoop[i-1], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Random_snoop[i-1], Random_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 3:
            Bottom_temp = np.add(Random_snoop[i-2], Random_snoop[i-3])
            Bottom      = np.add(Bottom_temp, Random_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 4:
            Bottom_temp = np.add(Random_snoop[i-3], Random_snoop[i-4])
            Bottom_ttemp= np.add(Bottom_temp, Random_snoop[i-2])
            Bottom      = np.add(Bottom_ttemp, Random_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
    else:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Random_snoop[i-1], label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Random_snoop[i-1], Random_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Bottom,label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 3:
            Bottom_temp = np.add(Random_snoop[i-2], Random_snoop[i-3])
            Bottom      = np.add(Bottom_temp, Random_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Random_snoop[i], width = len(SnoopType) *width, bottom=Bottom,label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
...
#my_xAxis = np.arange(0- (total_width - width) / 2,len(job_list)- (total_width - width) / 2, (1 / len(Random_order)))
#print(my_xlabel)
#print(my_xAxis)
plt.xticks(my_xAxis, my_xlabel,rotation=20, ha='right', fontsize=8) 
plt.legend(ncol = 5)
...
Standard_snoop = [[] for i in range(len(OrderSnoopType))]
for i in range(len(Standrad)):
    for j in range(len(Standrad[i])):
        if len(Standrad[i][j]) > 7:
            assert(len(Standrad[i][j]) == 8)
            for k in range(3, len(Standrad[i][j])):
                Standard_snoop[k+j*len(SnoopType)-3].append(Standrad[i][j][k])
        else:
            assert(len(Standrad[i][j]) == 7)
            for k in range(2, len(Standrad[i][j])):
                Standard_snoop[k+j*len(SnoopType)-2].append(Standrad[i][j][k])
...
for i in range(len(OrderSnoopType)):
    if i > 4:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType) *width, Standard_snoop[i], width = len(SnoopType) * width, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Standard_snoop[i-1], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Standard_snoop[i-1], Standard_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 3:
            Bottom_temp = np.add(Standard_snoop[i-2], Standard_snoop[i-3])
            Bottom      = np.add(Bottom_temp, Standard_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 4:
            Bottom_temp = np.add(Standard_snoop[i-3], Standard_snoop[i-4])
            Bottom_ttemp= np.add(Bottom_temp, Standard_snoop[i-2])
            Bottom      = np.add(Bottom_ttemp, Standard_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Bottom, fc=color_list_cnt[int(i%len(SnoopType))])
    else:
        if i % len(SnoopType) == 0:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 1:
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Standard_snoop[i-1], label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 2:
            Bottom = np.add(Standard_snoop[i-1], Standard_snoop[i-2])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Bottom,label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
        elif i % len(SnoopType) == 3:
            Bottom_temp = np.add(Standard_snoop[i-2], Standard_snoop[i-3])
            Bottom      = np.add(Bottom_temp, Standard_snoop[i-1])
            plt.bar(x+int(i/len(SnoopType))*len(SnoopType)*width, Standard_snoop[i], width = len(SnoopType) *width, bottom=Bottom,label = SnoopType[i], fc=color_list_cnt[int(i%len(SnoopType))])
...
for i in range(len(job_list)):
    plt.text(x[0] + 0.4 + i, 100000000, job_list[i], fontsize=14, color='black')
#my_xAxis = np.arange(0- (total_width - width) / 2,len(job_list)- (total_width - width) / 2, (1 / len(Standard_snoop)))
#print(my_xlabel)
#print(my_xAxis)
plt.xticks(my_xAxis, my_xlabel,rotation=20, ha='right', fontsize=8) 
plt.legend(ncol = 5)
