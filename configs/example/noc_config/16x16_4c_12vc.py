...
class CHI_RNV(CHI_config.CHI_RNV):
    class NoC_Params(CHI_config.CHI_RNV.NoC_Params):
        router_list = [  8,  10, 29, 31, #40, 41, 42, 43, 44, 45, 46, 47, 56, 57, 58, 59, 60, 61, 62, 63,
                       ...
                       197,199,208,210,#224,225,226,227,228,229,230,231,240,241,242,243,244,245,246,247,
